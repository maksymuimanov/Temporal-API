...
public final class ExampleConfiguredFeatures {
    @OreGeneration(
            ...
            replaceableBlocks = "minecraft:stone_ore_replaceables", size = 17,
    ...
    @GrassGeneration(blockId = "example:example_grass", biomeTag = "minecraft:is_taiga")
    ...
    @FlowerGeneration(
            ...
            highStateFlowers = "minecraft:dandelion", lowStateFlowers = "minecraft:dandelion",
    ...
    @TreeGeneration(saplingBlockId = "example:example_sapling", logBlockId = "example:example_log", leavesBlockId = "example:example_leaves",
