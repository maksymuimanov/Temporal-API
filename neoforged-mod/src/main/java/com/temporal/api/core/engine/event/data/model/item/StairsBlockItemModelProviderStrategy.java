...
public class StairsBlockItemModelProviderStrategy implements ItemModelProviderStrategy {
    @Override
    public void registerItemModel(Holder<? extends Item> itemRegistry, ApiItemModelProvider provider, String... additionalData) {
        ...
        provider.stairs(provider.getItemPath(item), ResourceUtils.parse(blockPath), ResourceUtils.parse(blockPath), ResourceUtils.parse(blockPath));
    }
}
