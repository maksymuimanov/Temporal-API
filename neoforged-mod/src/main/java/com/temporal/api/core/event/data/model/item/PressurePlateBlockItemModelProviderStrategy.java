...
public class PressurePlateBlockItemModelProviderStrategy implements ItemModelProviderStrategy {
    @Override
    public void registerItemModel(Holder<? extends Item> itemRegistry, ApiItemModelProvider provider, String... additionalData) {
        ...
        provider.pressurePlate(provider.getItemPath(item), ResourceUtils.parse(blockPath));
    }
}
