...
@Processor(RegisterParticleProvidersEventAnnotationProcessor.NAME)
public class RegisterParticleProvidersEventAnnotationProcessor extends AbstractEventAnnotationProcessor {
