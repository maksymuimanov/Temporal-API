...
import com.temporal.api.core.engine.event.data.biome.configuration.FlowerConfiguredFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.configuration.GrassConfiguredFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.configuration.OreConfiguredFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.configuration.TreeConfiguredFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.modifier.FlowerBiomeModifierDefinition;
import com.temporal.api.core.engine.event.data.biome.modifier.GrassBiomeModifierDefinition;
import com.temporal.api.core.engine.event.data.biome.modifier.OreBiomeModifierDefinition;
import com.temporal.api.core.engine.event.data.biome.modifier.TreeBiomeModifierDefinition;
import com.temporal.api.core.engine.event.data.biome.placement.FlowerPlacedFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.placement.GrassPlacedFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.placement.OrePlacedFeatureDefinition;
import com.temporal.api.core.engine.event.data.biome.placement.TreePlacedFeatureDefinition;
