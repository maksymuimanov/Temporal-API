...
public class FenceGateBlockItemModelProviderStrategy implements ItemModelProviderStrategy {
    @Override
    public void registerItemModel(Holder<? extends Item> itemRegistry, ApiItemModelProvider provider, String... additionalData) {
        ...
        provider.fenceGate(provider.getItemPath(item), ResourceUtils.parse(blockPath));
    }
}
