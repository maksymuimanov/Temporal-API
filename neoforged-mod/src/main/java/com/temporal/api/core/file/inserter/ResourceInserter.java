...
public class ResourceInserter implements FileContentInserter<String, Path> {
    ...
    private static final FileContentInserter<String, Path> PATH_JSON_INSERTER = new PathInserter();
