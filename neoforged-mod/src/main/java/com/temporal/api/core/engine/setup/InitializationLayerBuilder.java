package com.temporal.api.core.engine.setup;

import com.temporal.api.core.engine.EngineBuilder;
import com.temporal.api.core.engine.EngineTask;
import com.temporal.api.core.engine.setup.initializer.*;
import com.temporal.api.core.engine.setup.scanner.ClasspathModClassScanner;
...
public class InitializationLayerBuilder {
    ...
    private static final List<ObjectPoolInitializer> DEFAULT_INITIALIZERS = List.of(new DeferredRegisterPoolInitializer(), new FactoryPoolInitializer(), new EventBusPoolInitializer(), new ModContainerPoolInitializer(), new InjectedObjectPoolInitializer());
