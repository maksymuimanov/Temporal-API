package com.temporal.api.core.event.data.file;
...
public class AtlasTrimProvider implements FileProvider {
    public static final Tuple<Queue<ResourceLocation>, Map<String, ResourceLocation>> TRIM_INFO = new Tuple<>(new TemporalQueue<>(), new TemporalMap<>());
    ...
    public void registerFiles() {
        ...
        Queue<ResourceLocation> left = TRIM_INFO.getA();
        Map<String, ResourceLocation> right = TRIM_INFO.getB();
        if (!left.isEmpty()) {
        ...
        IOUtils.writeToFile(TARGET_FILE_PATH, FORMAT, trimPatterns, trimMaterials);
    }
}
