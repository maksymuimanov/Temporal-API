...
public class ButtonBlockItemModelProviderStrategy implements ItemModelProviderStrategy {
    @Override
    public void registerItemModel(Holder<? extends Item> itemRegistry, ApiItemModelProvider provider, String... additionalData) {
        ...
        provider.buttonInventory(provider.getItemPath(item), ResourceUtils.parse(blockPath));
    }
}
